...
file_name = '2021_06_07-12_47_02_PM'
...
ndelete = 4000000 # must be dividable by Nworkers (e.x. 10, 100, ...)
Nchain = 20000   # numder of chains(rows) per each worker
